...
def get_parser():
    ...
    parser.add_argument('--flow_type', type=str, default='none', help="The type of flow to be used, none, scf or glow")
    ...
    parser.add_argument('--freeze_encoder', type=bool_flag, default=False,
                        help='Whether freeze the parameteres of the encoder')
    parser.add_argument('--use_weight_network', type=bool_flag, default=False,
